            ...
            <Row>
                ...
                <Col lg={{ span: 8, offset: 0 }} className="mt-4">
                    <Card className={styles.chartContainer}>
                        ...
                        <Chart type={"Bar"} title={"Expense"} color={"red"} datas={chartData}>
                ...
                <Col lg={{ span: 4, offset: 0 }} className="mt-4">
                    <Card className={styles.sidebarContainer}>
                        <h1 className={styles.pageTitle}>Filter Expense Category Monthly</h1>
                        <BodyFormFilter datas={filterData} />
                    </Card>
                </Col>
                <Card className={styles.tableContainer}>
                    <h1 className={styles.pageTitle}>Recent Expanses</h1>
                    <Table datas={tableData} fetchData={fetchData} slug={query.slug} type={"expanse"}></Table>
                </Card>
            </Row>
        </div>
    );
